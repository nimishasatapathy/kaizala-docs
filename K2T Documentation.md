...
The conversion process can be completed by using the **Windows Command-Line** tool. If you have a Kaizala Action Package file and need it to be converted to the Teams app, then you can use a command-line tool available on Windows for the conversion process.
...
- If you don't have the Kaizala package that you want to transform into the Teams app, you can download a zip file from [Kaizala Management Portal](https://manage.kaiza.la/MiniApps/MiniApps).

**Conversion Steps**

1. Open a command-line tool on your machine.
